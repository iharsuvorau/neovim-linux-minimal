...
vim.keymap.set('n', '<leader>en', ':call search("^defp\\|^def\\|^defmodule")<CR>',
  { noremap = true, silent = true, desc = 'Next function' })
vim.keymap.set('n', '<leader>ep', ':call search("^defp\\|^def\\|^defmodule", "b")<CR>',
  { noremap = true, silent = true, desc = 'Previous function' })
